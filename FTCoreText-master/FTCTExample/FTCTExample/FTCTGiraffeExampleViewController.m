...
- (NSArray *)coreTextStyle
{
    ...
    //  Create style using convenience method   title标题
	...
	//titleStyle.paragraphInset = UIEdgeInsetsMake(120.f, 0, 0.f, 0);
	titleStyle.textAlignment = FTCoreTextAlignementCenter;
    
    titleStyle.appendedCharacter=@"#";
	[result addObject:titleStyle];
	
    //  Image will be centered  图像居中
